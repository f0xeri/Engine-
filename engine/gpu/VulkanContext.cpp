...
void VulkanContext::pickPhysicalDevice()
{
    for (const vk::PhysicalDevice& candidate : instance.enumeratePhysicalDevices())
    {
        ...
        if (!v13.dynamicRendering || !v13.synchronization2 || !v11.shaderDrawParameters ||
            ...
            !v12.drawIndirectCount || !v12.scalarBlockLayout || !core.multiDrawIndirect ||
            !core.samplerAnisotropy)
        {
            LOG_INFO(Vulkan,
...
void VulkanContext::createDevice()
{
    ...
    // Slang implements D3D SV_VertexID semantics as gl_VertexIndex - gl_BaseVertex,
    // which requires DrawParameters; gl_DrawID needs it later under MDI anyway.
